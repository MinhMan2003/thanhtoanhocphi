...
<div class="card">
    <form method="POST" action="index.php?controller=hoadon&action=create" class="form" id="invoiceForm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!hasItem) {
            e.preventDefault();
            alert('Vui lòng thêm ít nhất một khoản thu hợp lệ (đã chọn loại và nhập số tiền > 0).');
        }
    });
